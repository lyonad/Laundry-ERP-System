    ...
    <section className="py-20 bg-orange-500 text-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold mb-4">Student's Testimonials</h2>
        ...
        <div className="mt-12 flex justify-center gap-2">
           <button className="p-2 hover:bg-orange-600 rounded-full text-white/50 hover:text-white transition-colors">
              Wait, "Student's Testimonials"? Correction: <span className="font-bold text-white">Happy Customers</span>
           </button>
        </div>
      </div>
    </section>
