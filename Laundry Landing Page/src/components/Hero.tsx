        ...
        <div className="grid gap-12 lg:grid-cols-2 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <Button size="lg" className="h-14 px-8 text-base bg-orange-500 hover:bg-orange-600 text-white rounded-xl shadow-lg shadow-orange-200">
                Order Now
              </Button>
              <Button size="lg" variant="outline" className="h-14 px-8 text-base border-orange-200 text-orange-700 hover:bg-orange-50 rounded-xl bg-white">
