             ...
             <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
                <div>
                   ...
                   <div className="flex flex-col sm:flex-row gap-4">
                      <Button 
                        className="bg-white text-orange-600 hover:bg-orange-50 h-12 px-8 rounded-xl text-base shadow-lg"
                      ...
                      <Button 
                        variant="outline" 
                        className="border-orange-300 text-white hover:bg-orange-600/50 bg-transparent h-12 px-8 rounded-xl text-base"
                        onClick={() => navigate('/login')}
                      >
                        View Plans
                      </Button>
